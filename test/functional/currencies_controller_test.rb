...
class CurrenciesControllerTest < ActionController::TestCase
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post :create, currency: { is_enabled: @currency.is_enabled, name: @currency.name }
    end
  ...
  test "should update currency" do
    put :update, id: @currency, currency: { is_enabled: @currency.is_enabled, name: @currency.name }
    assert_redirected_to currency_path(assigns(:currency))
  end
